...
public class JMDictFuriHelper extends SQLiteOpenHelper{
     ...
     */
    public String getFuriganaFromDB(String word, String reading){
        String query = String.format("select furigana From jmdict where word = '%s' and reading = '%s'",
                word, reading);
